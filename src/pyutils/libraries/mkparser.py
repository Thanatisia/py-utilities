"""
Makefile-to-Python Parser

Retrieved from the main python package/library: [thanatisia/makefile-parser-python (https://github.com/Thanatisia/makefile-parser-python)] aka 'mkparse'
"""
import os
import sys
